          ...
          <form className="form-edit-profile">
            <div className="profile-edit-input-field-main">
              ...
              <div className="fields name-filed ">
                <input value={fistName} onChange={(e) => setFistName(e.target.value)} type="text" placeholder="First name" />
            ...
            <div className="select-fields-profile-edit">
              ...
              <div className="select-fields  row">
                <select className="district-select-field " name="" id="" value={district} onChange={(e) => setDistrict(e.target.value)}>
                ...
                <select className="division-select-field " name="" id="" value={division} onChange={(e) => setDivision(e.target.value)}>
