    ...
    <>
      <div className="tabs-component-main">
        <div className="row-tabs-component row">
          <button className={`btn-tab-name ${index === 1 && "btn-active-tab-name btn-tab-name"}`} onClick={handleAdmin}>
            Admin User Type
          </button>
          <button className={`btn-tab-name ${index === 0 && "btn-active-tab-name btn-tab-name"}`} onClick={handleEmployee}>
            Employee User Type
          </button>
        </div>
