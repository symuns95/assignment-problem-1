...
const UserInfo = (props) => {
  ...
  return (
    <>
      {heading ? (
        <div className={`container-user-info ${heading ? "container-user-info heading-container-user-info " : "container-user-info"} `}>
          <div className={`row user-info-row ${bg ? " user-info-row-bg" : " border-no-bg"}`}>
            <div className="user-info-col">
              <div className="name">{"Fistname Lastname"}</div>
            </div>
            <div className="user-info-col">
              <div className="district-dropdown">
                <select name="" id="" value={selectDistict} onChange={(e) => setSelectDistict(e.target.value)}>
            ...
            <div className="user-info-col">
              <div className="division-dropdown">
                <select name="" id="" value={selectDivision} onChange={(e) => setSelectDivision(e.target.value)}>
